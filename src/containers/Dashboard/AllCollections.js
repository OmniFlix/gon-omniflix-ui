...
class AllCollections extends Component {
    ...
    componentDidMount () {
        if (this.props.tabValue === 'all_collections' && !this.props.allCollectionsInProgress && this.props.chainValue &&
...
export default withRouter(connect(stateToProps, actionsToProps)(AllCollections));
